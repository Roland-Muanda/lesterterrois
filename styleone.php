...
<div id="popupOverlay2" class="popupOverlay">
    <div class="popupContent">
        ...
        <iframe id="popupIframe2" class="popupIframe" src="./D-web/styleone.activator.php"></iframe>
    </div>
</div>
...
<body>  
  <div class="telecharger">D-W≡/&gt; <h3 style="font-family: 'Papyrus', sans-serif; font-size:0.5em;">Style one</h3></div>  
</body>  
</html>  
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($result->num_rows > 0) {  
            echo "<script>
                ...
                window.location.href = './styleone.php';
            </script>";
            exit;
        }
