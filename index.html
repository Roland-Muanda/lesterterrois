...
<div id="popupOverlay2" class="popupOverlay">
    <div class="popupContent">
        ...
        <iframe id="popupIframe2" class="popupIframe" src="./D-web/activator.php"></iframe>
    </div>
</div>
...
function fermerPopup2() {
    ...
    <img src="./Mglogo.png" class="slide-text" style="border-radius:50%; width:58%;">
                <div class="slide-text">🌍 Concevez votre plate-forme avec nous !</div>
    <div class="slide-text">Obtenez un flyer numerique</div>
    <div class="slide-text"><a style="color: white;text-decoration: none;" 
                               href="http://lesterterrois.myartsonline.com/styleone.php">👉 Essayez Style one ⭐🌀</a></div>
...
@media screen and (max-width: 768px) {
    #sidebar {
        ...
        top: 9%;
        width: 95%;
        max-height: 75%; /* ✅ Ajuste la hauteur sur mobile */
...
@media screen and (max-width: 768px) {
    #container3 {
        width: 93%; /* ✅ Plus adapté aux écrans mobiles */
